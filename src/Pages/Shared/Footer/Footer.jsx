        ...
        <div className='bg-red-100' >
            ...
            <footer className="footer p-10 bg-base-200 text-base-content">
                <nav>
                    ...
                    <a href='' className="link link-hover">All Toys</a>
            ...
            <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content">
                <aside className="items-center ">
                    <a href=''><Link to={"/"}><img className='w-56' src="https://i.ibb.co/wKvm3Cg/logo.png" alt="" /></Link></a>
            ...
            <footer className="footer footer-center p-4 bg-base-300 text-base-content">
                <aside>
                    <p>Copyright © 2023 - All right reserved by Robo Tech</p>
                </aside>
            </footer>
        </div>
    );
